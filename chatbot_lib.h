#pragma once
// chatbot_lib.h — pure utility functions for sloperator
//
...
// ── Audio constants ───────────────────────────────────────────────────────────
// G.722 wideband codec operates at 16 kHz internally (RTP clock is still 8000
// per RFC 3551, but PJSIP handles that automatically).
...
inline std::string JsonGetString(const std::string& json,
